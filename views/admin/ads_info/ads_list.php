  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" class="table2">
      ...
      <tr class="hover">
		...
		<a class="option1" title="编辑" href="<?php echo site_url('admin/ads_info/edit_byid').'?id='.$ads->adsid;?>" target="rightFrame"><img src='<?php echo STATIC_IMG_PATH?>admin_img/edit.png'/></a>&nbsp;
