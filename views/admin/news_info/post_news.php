...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>
	<?php echo form_open_multipart('admin/news_info/Add_news',array('target'=>'rightFrame','name'=>'myform','id'=>'myform'));?>
	<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
	  ...
	  <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
		<div  class="input-div2"><input type="text" value="" id="source" class="input-text" style="width:400px;" name="source" ></div>
		</td>
      </tr>
	  <tr>
        <td height="30" width="10%" bgcolor="#FFFFFF" class="STYLE6">
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
		<div  class="input-div2"><input type="text" value="" id="author" class="input-text" name="author" ><span style="color:red;">注：留空则默认为“管理员”</span></div>
		</td>
      </tr>
	  ...
	  <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
		<div  class="input-div2">
		<label> <input name="image_upload" type="file" size="50"> </label>
		</div>
		</td>
      </tr>
	  <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
		<div  class="input-div2">
		<label> <input name="pic_upload" type="file" size="50"> </label>
		</div>
		</td>
      </tr>
	  <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
		<div  class="input-div2">
		<textarea name="news_desc" class="input-text" cols="60" rows="6"></textarea>
		</div>
		</td>
      </tr>
       <tr>
