...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 添加角色</span></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
  ...
  <tr>
    <td>
	<?php echo form_open('admin/role_info/add_role',array('target'=>'rightFrame','name'=>'myform','id'=>'myform'));?>
	<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      ...
      <tr>
		...
		<div  class="input-div2"><input type="text" value="" id="rname" class="input-text" name="rname"></div>
		</td>
      </tr>
	  <tr>
        <td height="30" width="10%" bgcolor="#FFFFFF" class="STYLE6">
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
		<div  class="input-div2"><textarea value="" id="rdesc" class="input-text"  rows="3" style="margin:5px;width:200px;" name="rdesc"></textarea></div>
		</td>
      </tr>
      <tr>
        <td height="30" width="10%" bgcolor="#FFFFFF" class="STYLE6">
	  ...
	  <tr>
		...
		<div  class="input-div2" style="margin-bottom:5px;">
		  ...
		  <input name="option[]" id="<?php echo $key.$li;?>" type="checkbox" <?php echo $item['a']=='update_pwd' || $item['a']=='logout' ? 'checked="checked" disabled="true"' : ''?>  style="margin-left:5px;" value="<?php echo $item['c'].'|'.$item['a']?>" /><label for="<?php echo $key.$li;?>" style="margin-right:10px;"><?php echo $item['name']?></label>
		  <?php }?> 
		  </fieldset>
		</div>
		<?php }?> 
	  ...
	  <tr>
		...
		<div class="input-div2"><input type="submit" value="添加角色" id="dosubmit"/></div>
		</td>
