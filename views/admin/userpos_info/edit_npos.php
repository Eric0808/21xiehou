...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 编辑会员、顾问推荐位</span></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
  ...
  <tr>
    <td>
	<?php echo form_open('admin/user_pos/edit_pos',array('target'=>'rightFrame','name'=>'myform','id'=>'myform'));?>
	<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
     <input type="hidden" value="<?php echo $posInfo['pid'];?>" name="editID">
      <tr>
        <td height="30" width="10%" bgcolor="#FFFFFF" class="STYLE6">
		<div class="input-div1"><span class="STYLE19">推荐位名称：</span></div>
		</td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
		<div  class="input-div2" ><input type="text" value="<?php echo $posInfo['name'];?>" id="upos_name" class="input-text" style="width:300px;" name="upos_name"></div>
		</td>
      </tr>
	  <tr>
        <td height="30" width="10%" bgcolor="#FFFFFF" class="STYLE6">
	  ...
	  <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
		<div  class="input-div2"><input type="text" value="<?php echo $posInfo['listorder'];?>" id="upos_order" class="input-text" name="upos_order"></div>
		</td>
      </tr>
	  <tr>
        <td height="30" width="10%" bgcolor="#FFFFFF" colspan="2" class="STYLE6">
		<div class="input-div2"><input type="submit" value="编辑推荐位" id="dosubmit"/></div>
		</td>
      </tr>
    </table>
	</form>
