          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 会员推荐位管理</span></td>
              </tr>
            </table></td>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" class="table2">
      <tr>
        ...
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">推荐位名称</span></div></td>
		 <td width="5%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">类型</span></div></td>
      ...
      <tr class="hover">
		<td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19"><?php echo $pos['pid'];?></span></div></td>
		<td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19"><?php echo $pos['name'];?></span></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19"><?php echo $pos['catid']==0?'会员推荐':'邂逅顾问推荐';?></span></div></td>
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
		<a class="option1" title="信息管理" href="<?php echo site_url('admin/user_pos/get_list_bypid').'?pid='.$pos['pid'];?>" target="rightFrame">信息管理</a> &nbsp;
		<a class="option1" title="编辑" href="<?php echo site_url('admin/user_pos/edit_pos').'?pid='.$pos['pid'];?>" target="rightFrame"><img src='<?php echo STATIC_IMG_PATH?>admin_img/edit.png'/></a> &nbsp;
		<a class="option1" title="删除" href="javascript:linkok('<?php echo site_url('admin/user_pos/del_pos').'?pid='.$pos['pid'];?>')" target="rightFrame"><img src='<?php echo STATIC_IMG_PATH?>admin_img/delete.gif'/></a> 
