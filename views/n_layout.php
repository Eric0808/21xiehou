  ...
  <div class="xiding">
    <div class="xidingc">
      <div class="xidingc01"><a href="#">征婚就选21邂逅网</a><a href="#"><img src="<?php echo STATIC_IMG_PATH;?>zhuye.gif" /></a><a href="#"><img src="<?php echo STATIC_IMG_PATH;?>xinlang.gif" /></a></div>
	   <?php echo form_open('search/fast',array('name'=>'searchForm','id'=>'searchForm','method'=>'get'));?>
	  ...
	  <span class="gray" style="display:none">您的居住地</span>
       ...
       <input type="checkbox" name="has_avatar" id="has_avatar" value="1" checked style="margin:2px 0 0 5px;"/><strong>有照片</strong><input <input name="tijiao" type="submit" value="" class="xdaniu" />
      </div>
	  </form>
      <div class="xdlogin" id="userinfo"><a href="<?php echo base_url(); ?>login/">登录</a><a href="<?php echo base_url(); ?>register/first/">免费注册</a></div>
      <!-- <div class="xdlogin"><span class="white">Hi&nbsp;&nbsp;</span><span class="white">峨眉</span><a href="#" class="biscuits">退出登录</a></span> <a href="#"><img src="images/qq.gif" /></a><a href="#"><img src="images/xl.gif" /></a></div>-->
    </div>
  </div>
<!-- 吸顶效果 end -->
<div id="bj"><!-- 最里层背景 --></div>
...
<!-- main end -->
<!-- for -->
  <div id="for" class="white"><p><a href="<?php echo base_url(),'page/help/?id=26';?>">关于邂逅</a> | <a href="<?php echo base_url(),'page/help/?id=27';?>">媒体报道</a> |  <a href="<?php echo base_url(),'page/help/?id=28';?>">网站合作</a> | <a href="<?php echo base_url(),'page/help/?id=29';?>">服务声明</a> | <a href="<?php echo base_url(),'page/help/?id=30';?>">隐私保护</a> | <a href="<?php echo base_url(),'page/help/?id=33';?>">诚聘英才</a> | <a href="<?php echo base_url(),'page/help/?id=34';?>">意见反馈</a> | <a href="<?php echo base_url(),'page/help/?id=36';?>">友情链接</a></p>客服热线：<span>400-818-7778</span> 传真号码：<span>010-59005600</span> 技术热线：<span>010-59005618</span> 客服邮箱：<span>jcxh99@126.com</span><br />
...
<script type=text/javascript src="<?php echo STATIC_JS_PATH;?>load.js"></script>
</body>
</html>